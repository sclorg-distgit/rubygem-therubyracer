...
Version: %{majorver}
Release: %{?preminorver:0.}%{release}%{?preminorver:.%{preminorver}}.sc1%{?dist}
...
gem install --local --install-dir .%{gem_dir} \
            -V \
            --force %{gem_name}-%{version}%{?preminorver}.gem
%{?scl:EOF}
...
%changelog
* Thu Mar 20 2014 Josef Stribny <jstribny@redhat.com> - 0.11.0-0.9.beta5
- Depend on scldevel(v8) virtual provide
  - Resolves: rhbz#1070332

* Mon Feb 17 2014 Josef Stribny <jstribny@redhat.com> - 0.11.0-0.8.beta5
- Don't install v8 scl macros, they should come in v8 scldevel subpackage
  - Resolves: rhbz#1065887

* Thu Nov 28 2013 Vít Ondruch <vondruch@redhat.com> - 0.11.0-0.7.beta5
- Depend on v8 scl.

* Thu Aug 01 2013 Tomas Hrcka <thrcka@redhat.com> - 0.11.0-0.6.beta5
- rebuild against new v8 
