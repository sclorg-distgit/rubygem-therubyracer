...
gem install \
        ...
        --document=ri,rdoc \
        --verbose \
        %{gem_name}-%{version}%{?preminorver}.gem \
        # This causes problems because of writing build info file
        #-- \
        #--with-v8-include=/opt/rh/v8314/root/usr/include \
        #--with-v8-lib=/opt/rh/v8314/root/usr/lib64
%{?scl:EOF}
...
cp -a .%{gem_extdir_mri}/v8/init.so %{buildroot}%{gem_extdir_mri}/v8
...
* Mon Jan 26 2015 Josef Stribny <jstribny@redhat.com> - 0.11.0-7
